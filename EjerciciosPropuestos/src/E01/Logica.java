...
public class Logica {
    ...
    public void generarEmpleado() {
        ...
        System.out.print("Escribe el salario de tu empleado: ");
        empleado.setSalario(lc.nextLine());
        System.out.println("Escribe la fecha de Nacimiento del nuevo empleado: ");
        empleado.setfechaNacimiento(lc.nextLine());
    ...
    public void incentivoGerente(){
        ...
        incentivo = Double.parseDouble(empleado.getSalario())*1.05;
    }
